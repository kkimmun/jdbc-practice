...
public class SelectRun {
	...
	*/
	...
	try {
		...
		// stmt.executeUpdate(sql); -> SQL문이 INSERT, UPDATE, DELETE 일 시 사용(DDL도 됨) 
		// 실행할 SQL문이 SELECT문
		...
		System.out.println("object추가를 하지 않았다");
		System.out.println("oracle.jdbc.driver.OracleDriver에 오타가 있다.");
	} catch (SQLException e) {
		System.out.println("jdbc:oracle:thin:@127.0.0.1:1521:XE에 오타가 있다.");
